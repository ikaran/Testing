...
struct thread {
	...
	#if OPT_A2
		struct filedescriptor *t_filetable;	//filetable
	#endif
	/*
	 * This is public because it isn't part of the thread system,
...
/*
thread_wakeupone does the same as thread_wakeup, except it only wakes up one thread sleeping on the specified address
*/
